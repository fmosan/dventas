...
@section('content')
    ...
    <form action="{{ route('detalle_compra.store') }}" method="POST">
        ...
        <div class="mb-3" style="width: 45%">
            ...
            <input id="idproveedor" name="idproveedor" type="text" class="form-control" tabindex="1" >
        </div>
        <div class="mb-3" style="width: 45%">
        ...
        <div class="mb-3">
            ...
            <input id="precio_compra" name="precio_compra" type="number" class="form-control" tabindex="1" value="0.00">
        </div>
        <div class="mb-3">
        ...
        <a href="/compra" class="btn btn-secondary" tabindex="5">Cancelar</a>
        <button href="" type="submit" class="btn btn-primary" tabindex="4">Agregar</button>
    </form>
